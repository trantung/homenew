...
@section('content')
    ...
    <div class="row margin-bottom">
        <div class="col-xs-12">
            <a href="{{ action('CardAdminController@index') }}" class="btn btn-success">Danh sách</a>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
                <!-- form start -->
                {{ Form::open(array('action' => array('CardAdminController@update', $data->id), 'method' => 'PUT')) }}
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                            {{ Form::select('role_id', [1=>'Admin', 2=>'Member'], $data->role_id, array('class' => 'form-control')) }}
                            </div>
                        </div>
                    </div>
                </div>
